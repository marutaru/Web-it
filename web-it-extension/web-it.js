  ...
  $(function() {
    ...
    return $.getJSON("http://marutaru.com:3000/getdata.json", function(jsonarr) {
      ...
      for (_i = 0, _len = jsonarr.length; _i < _len; _i++) {
        json = jsonarr[_i];
        _results.push($("body").append("<div class='sealed' style='position:absolute;left:" + json.position.x + "px;top:" + json.position.y + "px;background-color:forestgreen;opacity:0.8;border-radius:1em;padding:2px'><form action='http://marutaru.com:3000/deletedata.json' method='POST'>" + json.content + "<input type='submit' value='×'/></form></div>"));
      }
      return _results;
    });
  });
